      ...
      <div class="q-pa-xl">
        ...
        <div class="row q-col-gutter-md">
          <div class="col-xs-12 col-sm-12">
            <q-card class="dados-pessoais">
              <q-card-section>
                <div class="row q-col-gutter-md q-px-md q-py-lg">
                  <div class="col-xs-12 col-sm-12">
                  ...
                  <div class="col-xs-12 col-sm-6">
                    ...
                    />
                    <div
                      class="text-red required-alert"
                      v-if="$v.telefone.$error"
                    >
          ...
          <div class="col-xs-12 col-sm-12">
            <q-card class="dados-proficionais">
              <q-card-section>
                <div class="row q-col-gutter-md q-px-md q-py-lg">
                  <div class="col-xs-12 col-sm-12">
                    <div class="text-h6 h6 text-primary">
                      Dados Profissionais
                    </div>
                  </div>
